...
func +=(inout p1:CGPoint, p2:CGPoint) {
    p1 = p1 + p2
}
...
func +=(inout p1:CGPoint, p2:(CGFloat, CGFloat)) {
    p1 = p1 + p2
}
...
func +=(inout r:CGRect, p:(CGFloat, CGFloat)) {
    r = r + p
}
...
func +=(inout r1:CGRect, r2:(CGFloat, CGFloat, CGFloat, CGFloat)) {
    r1 = r1 + r2
}
